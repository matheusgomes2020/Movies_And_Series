...
import com.example.moviesaandseries.data.remote.dto.toSeries
...
class GetOnAirSeriesUseCase @Inject constructor(
    ...
    operator fun invoke(): Flow<Resource<List<Series>>> = flow {
        ...
        try {
            ...
            val series = repository.getAiryingSeries().map { it.toSeries() }
