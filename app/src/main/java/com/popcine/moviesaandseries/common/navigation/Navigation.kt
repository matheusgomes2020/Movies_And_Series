...
import com.popcine.moviesaandseries.presentation.signIn.LoginScreen
import com.popcine.moviesaandseries.presentation.sign_up.SignupScreen
import com.popcine.moviesaandseries.presentation.account_details.AccountDetailsScreen
import com.popcine.moviesaandseries.presentation.cast_grid.CastGridScreen
import com.popcine.moviesaandseries.presentation.cast_grid.CastGridViewModel
import com.popcine.moviesaandseries.presentation.person_detail.PersonDetailScreen
import com.popcine.moviesaandseries.presentation.person_Image.ImagePersonScreen
import com.popcine.moviesaandseries.presentation.episode.EpisodeScreen
import com.popcine.moviesaandseries.presentation.searchMovies.SearchMoviesScreen
import com.popcine.moviesaandseries.presentation.searchSeries.SearchSeriesScreen
import com.popcine.moviesaandseries.presentation.season.SeasonDetailScreen
import com.popcine.moviesaandseries.presentation.favorites.ProfileScreen
import com.popcine.moviesaandseries.presentation.movies_genres.MovieGenresScreen
import com.popcine.moviesaandseries.presentation.series_genres.SeriesGenresScreen
import com.popcine.moviesaandseries.presentation.movie_detail.MovieDetailScreen
import com.popcine.moviesaandseries.presentation.movie_list.MoviesScreen
import com.popcine.moviesaandseries.presentation.series_detail.SeriesDetailScreen
import com.popcine.moviesaandseries.presentation.series_list.SeriesScreen
import com.popcine.moviesaandseries.presentation.general.UserData
import com.popcine.moviesaandseries.presentation.grid_movies.MoviesGridScreen
import com.popcine.moviesaandseries.presentation.grid_movies.MoviesGridViewModel
import com.popcine.moviesaandseries.presentation.grid_series.SeriesGidScreen
import com.popcine.moviesaandseries.presentation.grid_series.SeriesGridViewModel
import com.popcine.moviesaandseries.presentation.home.HomeScreen
import com.popcine.moviesaandseries.presentation.splash.AnimatedSplashScreen
...
fun RootNavigationGraph(navController: NavHostController, viewModel: AuthViewModel) {
    ...
    NavHost(
        ...
        startDestination = AppGraph.splash.ROOT
    ) {
        composable(route = AppGraph.splash.ROOT) {
...
fun HomeNavGraph(navController: NavHostController, userData: UserData?, viewModel: AuthViewModel,
    ...
    NavHost(
        ...
        accountDetailsNavGraph( navController = navController, userData = userData, viewModel =viewModel , onSignOut = onSignOut )
...
fun NavGraphBuilder.accountDetailsNavGraph(navController: NavController, userData: UserData?, viewModel: AuthViewModel, onSignOut: () -> Unit ) {
    navigation(
    ...
    navigation(
        ...
        composable(route = AppGraph.image_cast_details.DETAILS + "/{imagePath}",
            ...
            navBackStackEntry.arguments?.getString("imagePath").let {
                ImagePersonScreen(it!!,navController, isSystemInDarkTheme())
            }
        }
    }
}
